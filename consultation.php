...
$con=mysqli_connect('localhost','root','','online_consultation');
    ...
    */
        ...
        $query2 ="INSERT INTO  `consultation`(`guest_name`,`guest_age`,`weight`,`guest_gender`,`guest_currentcon`,`guest_gmail`,`guest_allergy`,`problem`,`title`,`description`) VALUES ('$name','$age','$weight' ,'$gender','$q1','$email','$q2','$treatment' ,'$title','$desc')";
                    ...
                    <form id="appointment-form" role="form" method="post" action="#">
                         ...
                         <div class="wow fadeInUp" data-wow-delay="0.8s">
                              ...
                              <div class="col-md-12 col-sm-12">
                                   ...
                                   <input type="text" class="form-control"  name="title" placeholder="min 10 chars and max 40 chars">
                              
                                   <label for="Message">Description</label>
                                   <textarea class="form-control" rows="5" id="desc" name="desc" placeholder="Description (min 100 chars max 1000 chars)"></textarea>
